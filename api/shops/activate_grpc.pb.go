...
func (c *activateClient) Activate(ctx context.Context, in *ActivateRequest, opts ...grpc.CallOption) (*ActivateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shops.Activate/Activate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedActivateServer
...
// UnimplementedActivateServer must be embedded to have forward compatible implementations.
...
func (UnimplementedActivateServer) mustEmbedUnimplementedActivateServer() {}
...
func _Activate_Activate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shops.Activate/Activate",
	}
